...
$(".credentials_upload").not(this).each(function(){$(this.checked=!1);$(".credentials_file_btn").css("display","none")})});$(".credentials_upload").click(function(){this.checked&&($(".checkboxnone").checked=!1)});$(".checkboxNo").click(function(){this.checked&&$(".file_upload").css("display","none")})});