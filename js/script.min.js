...
p=document.createElement("td"),q=document.createElement("td"),r=document.createElement("td"),t=document.createElement("td"),e=document.createElement("tr");let v=document.createElement("a"),w=document.createElement("a");v.textContent="Unapproved"==b[6].value?"Approve":"Unapprove";w.textContent="Delete";d.innerHTML=b[0].value;f.innerHTML=b[1].value;k.innerHTML=b[2].value;l.innerHTML=b[3].value;m.innerHTML=b[4].value;n.innerHTML=`N${b[5].value}`;p.innerHTML=b[6].value;q.innerHTML=b[7].value;r.innerHTML=
"Unapproved"==b[6].value?`<a href="javascript:void(0)" rel="Approve" style="color: green;  text-decoration: none;" id=${b[0].value} class="app_status">Approve</a>`:`<a href="javascript:void(0)" rel="Unapprove" style="color: brown; text-decoration: none;" id=${b[0].value} class="app_status">Unapprove</a>`;t.innerHTML=`<a href="javascript:void(0)"  style="color: red;  text-decoration: none;" id=${b[0].value} class="del_record">Delete</a>`;e.appendChild(d);e.appendChild(f);e.appendChild(k);e.appendChild(l);
e.appendChild(m);e.appendChild(n);e.appendChild(p);e.appendChild(q);e.appendChild(r);e.appendChild(t);a.append(e)}),console.log("Record Found")};h();$(".del_record").click(function(a){a.preventDefault();let c=$(this).attr("id");console.log(c);let b=JSON.parse(localStorage.getItem("loans"));b.forEach(function(d,f){d[0].value===c&&(b.splice(f,1),console.log(d))});swal({title:"Deleted Loan",text:"Application has been successfully deleted",icon:"success",timer:1500,closeOnClickOutside:!1});$("#loan_record").load(location.href+
" #loan_record");setTimeout(()=>{localStorage.setItem("loans",JSON.stringify(b));h()},1600)});$(".app_status").click(function(a){a.preventDefault();let c=$(this).attr("id");console.log(c);a=$(this).attr("rel");let b=JSON.parse(localStorage.getItem("loans"));console.log(a);"Approve"==a?b.forEach(function(d,f){d[0].value===c&&(d[6].value="Approved",b.splice(f,1),b.push(d),localStorage.setItem("loans",JSON.stringify(b)),console.log(d))}):b.forEach(function(d,f){d[0].value===c&&(d[6].value="Unapproved",
b.splice(f,1),b.push(d),localStorage.setItem("loans",JSON.stringify(b)),console.log(d))});swal({title:"Operation Performed",text:"Application has been successfully updated",icon:"success",timer:1500,closeOnClickOutside:!1});$("#loan_record").load(location.href+" #loan_record");setTimeout(()=>{h();$("#login").fadeOut("slow");$(".loan_data").fadeIn("slow")},1500)});$(".file_upload").click(function(){$("#inpFile").click();setInterval(()=>{""===$("#inpFile").val()?$("#col_icon").css("display","none"):
($("#col_icon").css("display","block"),$(".file_upload").css("display","none"),$("#collatorial_input").val($("#inpFile").val()))},500)});$(".yes_collatoral").click(function(){this.checked?$(".file_upload").css("display","block"):$(".file_upload").css("display","none")});$(".credentials_upload").click(function(){this.checked?$(".credentials_file_btn").css("display","block"):$(".credentials_file_btn").css("display","none")});$(".credentials_file_btn").click(function(){$("#credentials_inpFile").click();
setInterval(()=>{""===$("#credentials_inpFile").val()?$("#cred_icon").css("display","none"):($("#cred_icon").css("display","block"),$(".credentials_file_btn").css("display","none"),$("#credentials_input").val($("#credentials_inpFile").val()))},500)});$(".checkbox1").click(function(){this.checked&&$(".checkbox1").not(this).each(function(){$(this.checked=!1)})});$(".checkbox2").click(function(){this.checked&&$(".checkbox2").not(this).each(function(){$(this.checked=!1)})});$(".checkbox3").click(function(){this.checked&&
$(".checkbox3").not(this).each(function(){$(this.checked=!1)})});$(".checkbox4").click(function(){this.checked&&$(".checkbox4").not(this).each(function(){$(this.checked=!1)})});$(".checkboxnone").click(function(){this.checked&&$(".credentials_upload").not(this).each(function(){$(this.checked=!1);$(".credentials_file_btn").css("display","none")})});$(".credentials_upload").click(function(){this.checked&&$(".checkboxnone").not(this).each(function(){$(this.checked=!1)})});$(".checkboxNo").click(function(){this.checked&&
